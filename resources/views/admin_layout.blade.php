...
<html>
    <head>
        ...
        <link href="{{asset('backend/assets/select2/select2.css')}}" rel="stylesheet" type="text/css" />
    ...
    <body class="fixed-left">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="md md-terrain"></i> <span>Admin Dashboard</span></a>
                    </div>
                </div>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        ...
                        <div class="user-info">
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> {{ Session::get('admin_name') }} <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-mail"></i><span> Manufacture </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-mail"></i><span> Manage Order </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{URL::to('/manage-order')}}">All Order</a></li>
                                </ul>
                            </li>
        ...
        <script src="{{asset('backend/assets/select2/select2.min.js')}}" type="text/javascript"></script>
