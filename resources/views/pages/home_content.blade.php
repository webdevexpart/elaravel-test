							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="{{URL::to($v_published_product->product_image)}}" alt="" style="height:250px"/>
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>BDT {{ $v_published_product->product_price }} Only</h2>
												<a href="{{ URL::to('/show-product/'.$v_published_product->product_id) }}"><p>{{ $v_published_product->product_name }}</p></a>
												<a href="{{ URL::to('/show-product/'.$v_published_product->product_id) }}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
								</div>
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										...
										<li><a href="{{ URL::to('/show-product/'.$v_published_product->product_id) }}"><i class="fa fa-eye"></i>View Product</a></li>
									</ul>
								</div>
							</div>
						</div>
