					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p>{{ $show_product->product_color }}</p>
								<img src="{{ URL::to('frontend/images/product-details/rating.png')}}" alt="" />
								<span>
									<span>{{ $show_product->product_price }} Tk</span>
								...
								<p><b>Category:</b> {{ $show_product->category_name }}</p>
								<p><b>Brand:</b> {{ $show_product->manufacture_name }}</p>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						...
						<div class="tab-content">
							<div class="tab-pane fade active in" id="details" >
                                {!! $show_product->product_long_description !!}
							</div>
